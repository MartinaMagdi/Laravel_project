                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                         ...
                                         <button type="button" class="btn btn-white border-1 border-primary">
                                            <a href="{{ url('auth/google') }}"
                                                class="btn btn-google btn-block text-capitalize btn-outline"
                                                href="#"><img
                                                    src="https://img.icons8.com/color/16/000000/google-logo.png"> Login
                                                Using Google</a>
                                        </button> 
                                         <button type="button" class="btn btn-white border-1 border-primary">
                                            <a href="{{ url('auth/facebook') }}" class="btn text-capitalize">
